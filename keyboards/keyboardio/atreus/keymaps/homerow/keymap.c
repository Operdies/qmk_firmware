...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT( /* Qwerty */
    ...
    KC_A,            KC_S,    KC_D,     LSFT_T(KC_F),     LGUI_T(KC_G),                               LGUI_T(KC_H), LSFT_T(KC_J),    KC_K,    KC_L,    KC_SCLN ,
    LSFT_T(KC_Z),    KC_X,    KC_C,     KC_V,             KC_B,         KC_GRV,       KC_BSLS,        KC_N,         KC_M,            KC_COMM, KC_DOT,  LSFT_T(KC_SLSH),
